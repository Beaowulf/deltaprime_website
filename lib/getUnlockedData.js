...
export async function fetchUnlockedData() {
  try {
    console.log("Checking Avalanche provider...");
    await avalancheProvider.getNetwork();
    console.log("Avalanche provider is connected.");

    console.log("Checking Arbitrum provider...");
    await arbitrumProvider.getNetwork();
    console.log("Arbitrum provider is connected.");
