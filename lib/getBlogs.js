...
export const fetchBlogs = async () => {
  const res = await client.getEntries({
    ...
    select: "fields.slug,fields.blogDescription,fields.previewImageBlog,fields.blogCategory,sys.id",
  });
...
export const fetchStrategies = async () => {
  const res = await client.getEntries({
    ...
    select: "fields.strategyTitle,fields.strategyDescription,fields.strategyImage,fields.difficultyLevel,fields.slug",
  });
...
export const fetchStrategyBySlug = async (slug) => {
  ...
  return {
    ...item.fields, // Spread all fields from the entry
    strategyID: item.sys.id, // Add system ID separately
  };
};
...
export const fetchHowToVideos = async () => {
  const res = await client.getEntries({
    ...
    select: "fields.howToVideoTitle,fields.howToVideoDescription,fields.howToVideoDescriptionImage,fields.slug",
  });
