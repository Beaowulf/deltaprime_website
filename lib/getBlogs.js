...
export const fetchBlogs = async () => {
  const [blogTestRes, newsLetterRes] = await Promise.all([
    client.getEntries({
      content_type: "blogTest",
      select:
        "fields.slug,fields.blogDescription,fields.previewImageBlog,fields.blogCategory,sys.id,fields.blogTitle,fields.isPartOfBlogs,fields.blogImage",
      order: "-sys.createdAt",
    }),
    client.getEntries({
      content_type: "newsLetterV01",
      select:
        "fields.slug,fields.newsLetterTitle,fields.blogCategory,fields.previewImageBlog,sys.id,fields.blogDescription,fields.blogTitle,fields.isNewsLetter",
      order: "-sys.createdAt",
    }),
  ]);
  ...
  return combinedItems.map((item) => ({
    ...
    isPartOfBlogs: item.fields.isPartOfBlogs,
    isNewsLetter: item.fields.isNewsLetter,
