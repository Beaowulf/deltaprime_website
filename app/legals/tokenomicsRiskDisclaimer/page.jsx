    ...
    <>
      ...
      <div className="pb-4 pagePaddingLarge">
        <div className="flex justify-center items-center flex-col w-auto h-full md:mt-20 mt-5">
          <p className="featureSubtitle mb-4 text-3xl md:text-[44px] mt-10">
        ...
        <div className="flex justify-center flex-col pl-6 pr-6 mt-10">
          ...
          <p className="aboutTypographyparagraphWhite font-normal leading-6 md:px-0 px-1 pb-1 mb-10">
        ...
        <div className="flex justify-center text-justify flex-col pl-6 pr-6 mt-10">
          ...
          <p className="aboutTypographyparagraphWhite font-normal leading-6 md:px-0 px-1 pb-1">
