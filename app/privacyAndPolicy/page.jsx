...
function PrivacyandPolicy() {
  return (
    <div className="pb-4">
      ...
      <div className="md:pl-[225px] flex justify-center text-justify flex-col pl-6 pr-6 mt-16 text-2xl md:w-full w-fit h-full md:pr-52">
        ...
        <p className="pt-5 font-light">
          ...
          inventore, illo debitis? Fuga quaerat officia, magni consequuntur iste
          itaque non!
        </p>
        <p className="pt-5 font-light">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque
      ...
      <div className="md:pl-[225px] flex justify-center text-justify flex-col pl-6 pr-6 mt-16 text-2xl md:w-full w-fit h-full md:pr-52 mb-20">
        <p className="font-extrabold">Lorem ipsum dolor</p>
        <p className="pt-5 font-light">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque
          veritatis ab amet, provident minima excepturi modi est, dolore
