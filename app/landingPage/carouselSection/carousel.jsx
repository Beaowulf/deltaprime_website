...
import { carouselImage } from "@/app/components/carouselImages/getCarouselImages";
  ...
  return (
    <div className="ignore_global_spacing relative fadedSides h-full pt-4">
      <Swiper
        ...
        modules={[Autoplay]}
        className="w-full h-[200px] z-0 pt-4"
      >
        {carouselImage.map((image, index) => {
          return (
            <SwiperSlide key={index}>
              <div
                className={`bg-white p-4 rounded-[20px] flex justify-center  ${
                  theme === "dark"
