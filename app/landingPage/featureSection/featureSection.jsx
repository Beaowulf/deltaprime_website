    ...
    <div className="md:mt-40 mt-0">
      ...
      <div className="flex items-center justify-cente md:mb-20 mb-6 flex-wrap">
        <div className="flex flex-wrap lg:flex-nowrap space-y-4 lg:space-y-0 lg:space-x-4 w-full md:h-[700px] h-full">
          ...
          >
            <div className="rounded-[20px] h-full px-4 pt-16 z-20 dark:bg-[#252948] bg-[#E8E8F2] overflow-hidden">
              {/* number and text */}
              <div className="mb-20">
                {theme === "dark" ? (
          ...
          <div className="sm:w-1/2 w-full flex flex-col space-y-4">
            ...
            >
              <div className="h-full rounded-[20px] dark:bg-[#252948] bg-[#E8E8F2] px-4 pt-6 pb-14 flex items-end justify-between">
                <div>
                  {theme === "dark" ? (
                    <Image
            ...
            >
              ...
              <div className="rounded-[20px] dark:bg-[#252948] bg-[#E8E8F2] px-4 pt-6  flex items-end justify-between h-full ">
                <div className="pb-14">
                  {theme === "dark" ? (
                    <Image
                  ...
                  <p className="featureCardTitle mt-2 dark:text-white text-[#252948] max-w-[10rem]">
      ...
      <div className="fullWidthButtonChildren h-[60px] md:h-full block sm:hidden">
