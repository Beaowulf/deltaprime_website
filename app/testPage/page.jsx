            ...
            <div className="flex flex-col w-full justify-between items-center lg:items-start h-fit lg:w-fit">
              ...
              <div className="leading-[150%] whiteMainText pl-3 md:pl-0 text-[15px] md:text-[17px] md:leading-[25.5px] max-w-[40rem] dark:text-white text-[#565AC2] md:text-left">
                <p>
                  ...
                  socials. We at DeltaPrime flocked together at the Summit. This
                  year, we did not have a booth and were unleashed on the floor.
                  This allowed us to seek out our partners, meet up and get that
                  extra bonding to strengthen our ties within Avalanche.
                  Similarly, we had some newer members with us to get to know
                  our partners face-to-face and exchange ideas. 
                </p>
                ...
                <p>
                  ...
                  interesting fireside among frens. We’ll let you know when the
                  full video is out. 
                </p>
              </div>
            </div>
              ...
              <div className="flex flex-col w-full justify-between items-center lg:items-start h-fit lg:w-fit">
                <div className="whiteMainText pl-3 md:pl-0 text-[15px] md:text-[17px] md:leading-[25.5px] leading-[150%]  max-w-[40rem] dark:text-white text-white ">
                  ...
                  <p>
                    ...
                    like to invite everyone to join the Discord to stay involved
                    and up-to-date.
                  </p>
                  <br />
                  <p>
                    ...
                    featured a new article with a deep-dive on Cross-Margin with
                    all the details, benefits, and a practical example of how it
                    sets DeltaPrime apart from other protocols.
                  </p>
                </div>
              </div>
              <div className="rounded-[25px] ">
          ...
          <div className="my-mobile-spacing md:my-desktop-spacing flex lg:flex-row flex-col justify-between items-center w-full md:gap-5 gap-2">
            ...
            <div className="flex flex-col w-full justify-between items-center lg:items-start h-fit lg:w-fit md:px-0 px-4">
              ...
              <div className="whiteMainText pl-3 md:pl-0 text-[15px] md:text-[17px] md:leading-[25.5px] leading-[150%]  max-w-[40rem] dark:text-white text-[#565AC2] ">
                <p>
                  Every month we will be diving into a new development from one
                  of our partners. The above expansion of the Avalanche
                  ecosystem leads us to this month’s partner spotlight. A large
                  and growing network of L1s needs a protocol to connect all
                  that liquidity, that’s where Tesseract comes in. 
                </p>
                <br />
                <p>
                  Tesseract is a new protocol built by the creators of Yield Yak
                  to offer a trustless, non-custodial, on-chain trading platform
          ...
          <div className="my-mobile-spacing md:my-desktop-spacing md:newsLetter_Linear_BG_MD newsLetter_Linear_BG_SM px-4 py-10 md:px-24 md:py-20 md:rounded-[25px]">
            <div className="flex flex-col gap-10">
              ...
              <div className="whiteMainText pl-3 md:pl-0 text-[15px] md:text-[17px] md:leading-[25.5px] leading-[150%]  w-full dark:text-white text-[#565AC2] ">
                <p>
                  The last couple of months were unique in DeltaPrime’s history.
                  We were forced to take ten steps back, reevaluating every
                  security procedure we have in play. While this led to massive
                  improvements on the security side, it also slowed down
                  development of the protocol significantly. For example,
                ...
                <br />
                <p>
                  Security remains number one. That will not change. However, as
                  we get to the point where all processes have been evaluated
                  and improved, we will also allocate dev-power to the things
                  you not only care about, but love to see. The first two coming
                  up?
                </p>
              </div>
              <div className="flex md:flex-row flex-col w-full justify-between gap-4 md:gap-10 md:px-0 px-10">
                <div className="flex flex-col gap-4 md:justify-start justify-center md:items-start items-center">
                  ...
                  <div className="w-full">
                    <p className="max-w-[15rem] md:max-w-[30rem] pl-2 whiteMainText md:pl-0 text-[15px] md:text-[17px] md:leading-[25.5px] leading-[150%]  w-full dark:text-white text-[#565AC2] md:m-0 mx-auto md:text-left text-center">
                      1. The Bull Meter, showing you how hedged you are on your
                      borrowable assets, regardless of whether you hold them in
                      your balance, GMX, Trader Joe, or elsewhere.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-4 md:justify-start justify-center md:items-start items-center">
                  ...
                  <div className="w-full">
                    <p className="max-w-[15rem] md:max-w-[30rem] pl-2 whiteMainText md:pl-0 text-[15px] md:text-[17px] md:leading-[25.5px] leading-[150%]  w-full dark:text-white text-[#565AC2] md:m-0 mx-auto md:text-left text-center">
                      2. PA PnL, which tells you how you have been performing so
                      far.
                    </p>
                  </div>
                </div>
