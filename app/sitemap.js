...
export async function sitemap() {
  ...
  const staticRoutes = [
    ...
    { url: `${baseUrl}/blogs/academy/glossary`, lastModified: new Date().toISOString() },
    { url: `${baseUrl}/legals/terms-Of-Use`, lastModified: new Date().toISOString() },
    { url: `${baseUrl}/legals/privacy-And-Policy`, lastModified: new Date().toISOString() },
    { url: `${baseUrl}/legals/tokenomics-Risk-Disclaimer`, lastModified: new Date().toISOString() },
  ...
  return [...staticRoutes, ...blogUrls, ...howToVideoUrls, ...strategyUrls, ...jobDescriptionUrls];
}
